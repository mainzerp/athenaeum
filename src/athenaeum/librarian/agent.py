...
class Librarian:
        ...
        *,
        ...
        async with self._run_gate.acquire(self.config.user_id, KIND_LIBRARIAN, wait=False):
            ...
            task = (
                ...
                "deprecate_concept when a whole concept is obsolete, "
                "delete_concept only when removal is clearly intended. Supersede "
    ...
    async def _write_result(self, result: _RunResult) -> dict:
