...
- **WebUI** — FastAPI + Jinja2 templates + htmx (+ Alpine.js for small interactions); the graph page and the trace replay graph render as a 2D sunburst on a plain canvas (no WebGL). No Node toolchain; htmx loads from CDN.
